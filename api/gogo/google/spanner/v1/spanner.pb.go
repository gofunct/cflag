...
func (ExecuteSqlRequest_QueryMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSpanner, []int{6, 0}
}
...
func (*ListSessionsRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{3} }
...
func (*ListSessionsResponse) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{4} }
...
func (*DeleteSessionRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{5} }
...
func (*ExecuteSqlRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{6} }
...
func (*ReadRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{7} }
...
func (*BeginTransactionRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{8} }
...
func (*CommitRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{9} }
...
func (*CommitResponse) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{10} }
...
func (*RollbackRequest) Descriptor() ([]byte, []int) { return fileDescriptorSpanner, []int{11} }
