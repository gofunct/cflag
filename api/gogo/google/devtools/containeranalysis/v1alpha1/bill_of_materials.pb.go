...
func (PackageManager_Architecture) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorBillOfMaterials, []int{0, 0}
}
...
func (*PackageManager) Descriptor() ([]byte, []int) { return fileDescriptorBillOfMaterials, []int{0} }
...
func (*PackageManager_Location) Descriptor() ([]byte, []int) {
	return fileDescriptorBillOfMaterials, []int{0, 1}
}
...
func (*PackageManager_Package) Descriptor() ([]byte, []int) {
	return fileDescriptorBillOfMaterials, []int{0, 2}
}
...
func (*PackageManager_Installation) Descriptor() ([]byte, []int) {
	return fileDescriptorBillOfMaterials, []int{0, 3}
}
...
func init() {
	proto.RegisterFile("google/devtools/containeranalysis/v1alpha1/bill_of_materials.proto", fileDescriptorBillOfMaterials)
}

var fileDescriptorBillOfMaterials = []byte{
