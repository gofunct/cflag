...
type Flag struct {
	...
	Hellp      string     `protobuf:"bytes,2,opt,name=hellp,proto3" json:"hellp,omitempty"`
...
func (*Flag) Descriptor() ([]byte, []int) {
	return fileDescriptor_cflag_f84ec545f9ad8305, []int{0}
}
...
func (this *Flag) GoString() string {
	...
	s = append(s, "Hellp: "+fmt.Sprintf("%#v", this.Hellp)+",\n")
...
func (m *Flag) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Hellp) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintCflag(dAtA, i, uint64(len(m.Hellp)))
		i += copy(dAtA[i:], m.Hellp)
	}
...
func (this *Flag) String() string {
	...
	s := strings.Join([]string{`&Flag{`,
		...
		`Hellp:` + fmt.Sprintf("%v", this.Hellp) + `,`,
...
func (m *Flag) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Hellp", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Hellp = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
...
func init() { proto.RegisterFile("cflag.proto", fileDescriptor_cflag_f84ec545f9ad8305) }

var fileDescriptor_cflag_f84ec545f9ad8305 = []byte{
	// 286 bytes of a gzipped FileDescriptorProto
	,
}
