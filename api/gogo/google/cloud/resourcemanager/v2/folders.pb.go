...
func (Folder_LifecycleState) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorFolders, []int{0, 0}
}
...
func (FolderOperation_OperationType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorFolders, []int{11, 0}
}
...
func (*Folder) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{0} }
...
func (*ListFoldersRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{1} }
...
func (*ListFoldersResponse) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{2} }
...
func (*SearchFoldersRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{3} }
...
func (*SearchFoldersResponse) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{4} }
...
func (*GetFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{5} }
...
func (*CreateFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{6} }
...
func (*MoveFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{7} }
...
func (*UpdateFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{8} }
...
func (*DeleteFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{9} }
...
func (*UndeleteFolderRequest) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{10} }
...
func (*FolderOperation) Descriptor() ([]byte, []int) { return fileDescriptorFolders, []int{11} }
...
func init() {
	proto.RegisterFile("google/cloud/resourcemanager/v2/folders.proto", fileDescriptorFolders)
}

var fileDescriptorFolders = []byte{
