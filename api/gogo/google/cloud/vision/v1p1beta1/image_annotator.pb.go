...
func (*WebDetectionParams) Descriptor() ([]byte, []int) {
	return fileDescriptorImageAnnotator, []int{15}
}
...
func (*ImageContext) Descriptor() ([]byte, []int) { return fileDescriptorImageAnnotator, []int{16} }
...
func (*BatchAnnotateImagesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorImageAnnotator, []int{20}
}
...
func init() {
	proto.RegisterFile("google/cloud/vision/v1p1beta1/image_annotator.proto", fileDescriptorImageAnnotator)
}
