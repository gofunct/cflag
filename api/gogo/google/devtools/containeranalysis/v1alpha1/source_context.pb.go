...
func (AliasContext_Kind) EnumDescriptor() ([]byte, []int) {
	return fileDescriptorSourceContext, []int{1, 0}
}
...
func (*AliasContext) Descriptor() ([]byte, []int) { return fileDescriptorSourceContext, []int{1} }
...
func (*CloudRepoSourceContext) Descriptor() ([]byte, []int) {
	return fileDescriptorSourceContext, []int{2}
}
...
func (*GerritSourceContext) Descriptor() ([]byte, []int) { return fileDescriptorSourceContext, []int{3} }
...
func (*GitSourceContext) Descriptor() ([]byte, []int) { return fileDescriptorSourceContext, []int{4} }
...
func (*RepoId) Descriptor() ([]byte, []int) { return fileDescriptorSourceContext, []int{5} }
...
func (*ProjectRepoId) Descriptor() ([]byte, []int) { return fileDescriptorSourceContext, []int{6} }
...
func init() {
	proto.RegisterFile("google/devtools/containeranalysis/v1alpha1/source_context.proto", fileDescriptorSourceContext)
}
