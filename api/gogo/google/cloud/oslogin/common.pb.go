...
func (*PosixAccount) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{0} }
...
func (*SshPublicKey) Descriptor() ([]byte, []int) { return fileDescriptorCommon, []int{1} }
...
func init() { proto.RegisterFile("google/cloud/oslogin/common.proto", fileDescriptorCommon) }
